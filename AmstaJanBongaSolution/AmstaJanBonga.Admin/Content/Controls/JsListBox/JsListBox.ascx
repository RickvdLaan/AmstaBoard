            ...
            <div class="js-listbox-wrapper">            
                <div class="js-listbox-source">
                    ...
                    <div class="js-listbox-button-area">
                        <ul>
                            <li>
                                <asp:LinkButton runat="server" ID="_lbTransferToDestination" CssClass="fa fa-arrow-right" aria-hidden="true" OnClick="_lbTransferToDestination_Click" />
                            </li>
                            <li>
                                <asp:LinkButton runat="server" ID="_lbTransferToSource" CssClass="fa fa-arrow-left" aria-hidden="true" OnClick="_lbTransferToSource_Click" />
                            </li>
                        </ul>
                    </div>
                </div>
