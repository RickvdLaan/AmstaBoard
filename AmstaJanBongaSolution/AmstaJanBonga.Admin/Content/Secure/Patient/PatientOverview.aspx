                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="options" HeaderStyle-CssClass="center details-width">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton runat="server" ToolTip="Verwijderen" CssClass="delete fa fa-trash" OnClick="_lbDelete_Click" OnClientClick="return confirm('U staat op het punt om deze bewoner te verwijderen. Weet u het zeker?');" CommandArgument='<%# Eval("Id") %>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
