...
<asp:Content ID="Content4" ContentPlaceHolderID="_cphExplanation" runat="server">
    Dit is het overzicht van de corveediensten, vanuit hier kunnen corveediensten worden beheerd.
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="_cphContent" runat="server">
    <div class="box">
        ...
        <div class="gridview">
            <asp:GridView runat="server" ID="_gvChores" OnPreRender="_gvChores_PreRender" OnPageIndexChanging="_gvChores_PageIndexChanging" PagerStyle-CssClass="paging" ShowHeaderWhenEmpty="true" AlternatingRowStyle-CssClass="alt" AllowPaging="true" PageSize="10" AllowSorting="false" AutoGenerateColumns="false">
                <Columns>    
                    <asp:TemplateField>
                        <HeaderTemplate>
                            Datum
