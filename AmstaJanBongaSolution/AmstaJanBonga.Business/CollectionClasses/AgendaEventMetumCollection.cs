...
namespace AmstaJanBonga.Business.CollectionClasses
{
	...
	public partial class AgendaEventMetumCollection : EntityCollectionBase<AgendaEventMetumEntity>
	{
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity agendaEventInstance, IEntity patientInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity agendaEventInstance, IEntity patientInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
