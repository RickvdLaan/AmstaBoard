...
namespace AmstaJanBonga.Business.CollectionClasses
{
	...
	/// <summary>Collection class for storing and retrieving collections of PatientEntity objects. </summary>
	[Serializable]
	public partial class PatientCollection : EntityCollectionBase<PatientEntity>
	{
		/// <summary> CTor</summary>
		public PatientCollection():base(new PatientEntityFactory())
		{
		}

		/// <summary> CTor</summary>
		/// <param name="initialContents">The initial contents of this collection.</param>
		public PatientCollection(IEnumerable<PatientEntity> initialContents):base(new PatientEntityFactory())
		{
		...
		public PatientCollection(IEntityFactory entityFactoryToUse):base(entityFactoryToUse)
		{
		}
		...
		protected PatientCollection(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		...
		public object GetScalar(PatientFieldIndex fieldIndex, AggregateFunction aggregateToApply)
		{
		...
		/// <param name="aggregateToApply">Aggregate function to apply. </param>
		/// <returns>the scalar value requested</returns>
		public object GetScalar(PatientFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(PatientFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter)
		{
		...
		/// <returns>the scalar value requested</returns>
		public object GetScalar(PatientFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IGroupByCollection groupByClause)
		{
		...
		/// <param name="groupByClause">The groupby clause to apply to retrieve the scalar</param>
		/// <returns>the scalar value requested</returns>
		public virtual object GetScalar(PatientFieldIndex fieldIndex, IExpression expressionToExecute, AggregateFunction aggregateToApply, IPredicate filter, IRelationCollection relations, IGroupByCollection groupByClause)
		{
			...
			return DAOFactory.CreatePatientDAO().GetScalar(fields, this.Transaction, filter, relations, groupByClause);
		}
