...
namespace AmstaJanBonga.Business.CollectionClasses
{
	...
	public partial class EmployeeCollection : EntityCollectionBase<EmployeeEntity>
	{
		...
		public bool GetMultiManyToOne(IEntity userInstance)
		{
			return GetMultiManyToOne(userInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, null, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity userInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(userInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, filter, 0, 0);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity userInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(userInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity userInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			...
			return DAOFactory.CreateEmployeeDAO().GetMulti(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, filter, userInstance, pageNumber, pageSize);
		}
		...
		public int DeleteMultiManyToOne(IEntity userInstance)
		{
			return DAOFactory.CreateEmployeeDAO().DeleteMulti(this.Transaction, userInstance);
		}
		...
		/// <param name="userInstance">UserEntity instance to use as a filter for the EmployeeEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(EmployeeEntity entityWithNewValues, IEntity userInstance)
		{
			return DAOFactory.CreateEmployeeDAO().UpdateMulti(entityWithNewValues, this.Transaction, userInstance);
		}
