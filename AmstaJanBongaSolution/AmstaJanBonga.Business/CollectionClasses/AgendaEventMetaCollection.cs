...
namespace AmstaJanBonga.Business.CollectionClasses
{
	...
	public partial class AgendaEventMetaCollection : EntityCollectionBase<AgendaEventMetaEntity>
	{
		...
		public bool GetMultiManyToOne(IEntity agendaEventInstance)
		{
			return GetMultiManyToOne(agendaEventInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, null, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity agendaEventInstance, IPredicateExpression filter)
		{
			return GetMultiManyToOne(agendaEventInstance, this.MaxNumberOfItemsToReturn, this.SortClauses, filter, 0, 0);
		}
		...
		/// <param name="filter">Extra filter to limit the resultset. Predicate expression can be null, in which case it will be ignored.</param>
		/// <returns>true if succeeded, false otherwise</returns>
		public bool GetMultiManyToOne(IEntity agendaEventInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter)
		{
			return GetMultiManyToOne(agendaEventInstance, maxNumberOfItemsToReturn, sortClauses, filter, 0, 0);
		}
		...
		/// <returns>true if succeeded, false otherwise</returns>
		public virtual bool GetMultiManyToOne(IEntity agendaEventInstance, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IPredicateExpression filter, int pageNumber, int pageSize)
		{
			bool validParameters = false;
			validParameters |= (agendaEventInstance!=null);
			if(!validParameters)
			{
			...
			return DAOFactory.CreateAgendaEventMetaDAO().GetMulti(this.Transaction, this, maxNumberOfItemsToReturn, sortClauses, this.EntityFactoryToUse, filter, agendaEventInstance, pageNumber, pageSize);
		}
		...
		public int DeleteMultiManyToOne(IEntity agendaEventInstance)
		{
			return DAOFactory.CreateAgendaEventMetaDAO().DeleteMulti(this.Transaction, agendaEventInstance);
		}
		...
		/// <param name="agendaEventInstance">AgendaEventEntity instance to use as a filter for the AgendaEventMetaEntity objects to return</param>
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMultiManyToOne(AgendaEventMetaEntity entityWithNewValues, IEntity agendaEventInstance)
		{
			return DAOFactory.CreateAgendaEventMetaDAO().UpdateMulti(entityWithNewValues, this.Transaction, agendaEventInstance);
		}
