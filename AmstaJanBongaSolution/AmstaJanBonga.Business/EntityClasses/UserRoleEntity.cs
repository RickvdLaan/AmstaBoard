...
namespace AmstaJanBonga.Business.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		/// <summary>CTor</summary>
		/// <param name="userId">PK value for UserRole which data should be fetched into this UserRole object</param>
		public UserRoleEntity(System.Int32 userId):base("UserRoleEntity")
		{
		...
		public UserRoleEntity(System.Int32 userId, IPrefetchPath prefetchPathToUse):base("UserRoleEntity")
		{
		...
		public UserRoleEntity(System.Int32 userId, IValidator validator):base("UserRoleEntity")
		{
		...
		{
			switch((UserRoleFieldIndex)fieldIndex)
			{
				case UserRoleFieldIndex.UserId:
		...
		/// <summary> Retrieves the related entity of type 'UserEntity', using a relation of type '1:1'</summary>
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", AmstaJanBonga.Business.RelationClasses.StaticUserRoleRelations.UserEntityUsingUserIdStatic, true, signalRelatedEntity, "UserRole", false, new int[] { (int)UserRoleFieldIndex.UserId } );
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", AmstaJanBonga.Business.RelationClasses.StaticUserRoleRelations.UserEntityUsingUserIdStatic, true, ref _alreadyFetchedUser, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 userId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)UserRoleFieldIndex.UserId].ForcedCurrentValueWrite(userId);
		...
		{
			get	{ return new PrefetchPathElement(new AmstaJanBonga.Business.CollectionClasses.UserCollection(), (IEntityRelation)GetRelationsForField("User")[0], (int)AmstaJanBonga.Business.EntityType.UserRoleEntity, (int)AmstaJanBonga.Business.EntityType.UserEntity, 0, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
			...
			set
			{
				...
				else
				{
					...
					else
					{
						if(_user!=value)
						{
							((IEntity)value).SetRelatedEntity(this, "UserRole");
							SetupSyncUser(value);
						}
					}
				}
