...
namespace AmstaJanBonga.Business.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'General'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class GeneralEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static GeneralEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public GeneralEntity() :base("GeneralEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="livingroomId">PK value for General which data should be fetched into this General object</param>
		public GeneralEntity(System.Int32 livingroomId):base("GeneralEntity")
		{
		...
		public GeneralEntity(System.Int32 livingroomId, IPrefetchPath prefetchPathToUse):base("GeneralEntity")
		{
		...
		/// <summary>CTor</summary>
		/// <param name="livingroomId">PK value for General which data should be fetched into this General object</param>
		/// <param name="validator">The custom validator object for this GeneralEntity</param>
		public GeneralEntity(System.Int32 livingroomId, IValidator validator):base("GeneralEntity")
		{
		...
		protected GeneralEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((GeneralFieldIndex)fieldIndex)
			{
				case GeneralFieldIndex.LivingroomId:
		...
		{
			return new GeneralRelations().GetAllRelations();
		}
		...
		/// <param name="livingroomId">PK value for General which data should be fetched into this General object</param>
		/// <param name="validator">The validator object for this GeneralEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		...
		private void InitClassMembers()
		{
			...
			_generalInformations.SetContainingEntityInfo(this, "General");
		...
		{
			this.PerformDesetupSyncRelatedEntity( _livingroom, new PropertyChangedEventHandler( OnLivingroomPropertyChanged ), "Livingroom", AmstaJanBonga.Business.RelationClasses.StaticGeneralRelations.LivingroomEntityUsingLivingroomIdStatic, true, signalRelatedEntity, "General", false, new int[] { (int)GeneralFieldIndex.LivingroomId } );
			_livingroom = null;
		}
		...
		private void SetupSyncLivingroom(IEntityCore relatedEntity)
		{
			if(_livingroom!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _livingroom, new PropertyChangedEventHandler( OnLivingroomPropertyChanged ), "Livingroom", AmstaJanBonga.Business.RelationClasses.StaticGeneralRelations.LivingroomEntityUsingLivingroomIdStatic, true, ref _alreadyFetchedLivingroom, new string[] {  } );
			}
		}
		...
		private bool Fetch(System.Int32 livingroomId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			...
			{
				OnFetch();
				this.Fields[(int)GeneralFieldIndex.LivingroomId].ForcedCurrentValueWrite(livingroomId);
		...
		public  static GeneralRelations Relations
		{
			get	{ return new GeneralRelations(); }
		}
		...
		{
			get { return new PrefetchPathElement(new AmstaJanBonga.Business.CollectionClasses.GeneralInformationCollection(), (IEntityRelation)GetRelationsForField("GeneralInformations")[0], (int)AmstaJanBonga.Business.EntityType.GeneralEntity, (int)AmstaJanBonga.Business.EntityType.GeneralInformationEntity, 0, null, null, null, "GeneralInformations", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new AmstaJanBonga.Business.CollectionClasses.LivingroomCollection(), (IEntityRelation)GetRelationsForField("Livingroom")[0], (int)AmstaJanBonga.Business.EntityType.GeneralEntity, (int)AmstaJanBonga.Business.EntityType.LivingroomEntity, 0, null, null, null, "Livingroom", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToOne);	}
		}
		...
		/// <summary> The DateCreated property of the Entity General<br/><br/></summary>
		/// <remarks>Mapped on  table field: "GeneralLivingroom"."DateCreated"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime DateCreated
		{
			get { return (System.DateTime)GetValue((int)GeneralFieldIndex.DateCreated, true); }
			set	{ SetValue((int)GeneralFieldIndex.DateCreated, value, true); }
		}

		/// <summary> The DateDeleted property of the Entity General<br/><br/></summary>
		...
		{
			get { return (Nullable<System.DateTime>)GetValue((int)GeneralFieldIndex.DateDeleted, false); }
			set	{ SetValue((int)GeneralFieldIndex.DateDeleted, value, true); }
		}

		/// <summary> The DateLastModified property of the Entity General<br/><br/></summary>
		...
		{
			get { return (Nullable<System.DateTime>)GetValue((int)GeneralFieldIndex.DateLastModified, false); }
			set	{ SetValue((int)GeneralFieldIndex.DateLastModified, value, true); }
		}

		/// <summary> The DateLastModifiedByUserId property of the Entity General<br/><br/></summary>
		...
		{
			get { return (Nullable<System.Int32>)GetValue((int)GeneralFieldIndex.DateLastModifiedByUserId, false); }
			set	{ SetValue((int)GeneralFieldIndex.DateLastModifiedByUserId, value, true); }
		}

		/// <summary> The Description property of the Entity General<br/><br/></summary>
		/// <remarks>Mapped on  table field: "GeneralLivingroom"."Description"<br/>
		/// Table field type characteristics (type, precision, scale, length): VarChar, 0, 0, 50<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String Description
		{
			get { return (System.String)GetValue((int)GeneralFieldIndex.Description, true); }
			set	{ SetValue((int)GeneralFieldIndex.Description, value, true); }
		}

		/// <summary> The IsActive property of the Entity General<br/><br/></summary>
		/// <remarks>Mapped on  table field: "GeneralLivingroom"."IsActive"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsActive
		{
			get { return (System.Boolean)GetValue((int)GeneralFieldIndex.IsActive, true); }
			set	{ SetValue((int)GeneralFieldIndex.IsActive, value, true); }
		}

		/// <summary> The IsMarkedAsDeleted property of the Entity General<br/><br/></summary>
		/// <remarks>Mapped on  table field: "GeneralLivingroom"."IsMarkedAsDeleted"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IsMarkedAsDeleted
		{
			get { return (System.Boolean)GetValue((int)GeneralFieldIndex.IsMarkedAsDeleted, true); }
			set	{ SetValue((int)GeneralFieldIndex.IsMarkedAsDeleted, value, true); }
		}

		/// <summary> The LivingroomId property of the Entity General<br/><br/></summary>
		...
		{
			get { return (System.Int32)GetValue((int)GeneralFieldIndex.LivingroomId, true); }
			set	{ SetValue((int)GeneralFieldIndex.LivingroomId, value, true); }
		}
			...
			set
			{
				...
				else
				{
					...
					else
					{
						...
						{
							((IEntity)value).SetRelatedEntity(this, "General");
							SetupSyncLivingroom(value);
						}
					}
				}
		...
		{ 
			get { return (int)AmstaJanBonga.Business.EntityType.GeneralEntity; }
		}
