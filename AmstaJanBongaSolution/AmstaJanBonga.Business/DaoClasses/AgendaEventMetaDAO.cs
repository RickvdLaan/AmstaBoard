...
namespace AmstaJanBonga.Business.DaoClasses
{
	...
	public partial class AgendaEventMetaDAO : CommonDaoBase
	{
		...
		public bool GetMulti(ITransaction containingTransaction, IEntityCollection collectionToFill, long maxNumberOfItemsToReturn, ISortExpression sortClauses, IEntityFactory entityFactoryToUse, IPredicateExpression filter, IEntity agendaEventInstance, int pageNumber, int pageSize)
		{
			...
			IPredicateExpression selectFilter = CreateFilterUsingForeignKeys(agendaEventInstance, fieldsToReturn);
			if(filter!=null)
			{
		...
		public int DeleteMulti(ITransaction containingTransaction, IEntity agendaEventInstance)
		{
			...
			IPredicateExpression deleteFilter = CreateFilterUsingForeignKeys(agendaEventInstance, fields);
		...
		/// <returns>Amount of entities affected, if the used persistent storage has rowcounting enabled.</returns>
		public int UpdateMulti(IEntity entityWithNewValues, ITransaction containingTransaction, IEntity agendaEventInstance)
		{
			IEntityFields fields = EntityFieldsFactory.CreateEntityFieldsObject(AmstaJanBonga.Business.EntityType.AgendaEventMetaEntity);
			IPredicateExpression updateFilter = CreateFilterUsingForeignKeys(agendaEventInstance, fields);
		...
		private IPredicateExpression CreateFilterUsingForeignKeys(IEntity agendaEventInstance, IEntityFields fieldsToReturn)
		{
