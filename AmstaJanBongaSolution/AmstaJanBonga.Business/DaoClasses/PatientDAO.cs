...
namespace AmstaJanBonga.Business.DaoClasses
{
	...
	/// <summary>General DAO class for the Patient Entity. It will perform database oriented actions for a entity of type 'PatientEntity'.</summary>
	public partial class PatientDAO : CommonDaoBase
	{
		/// <summary>CTor</summary>
		public PatientDAO() : base(InheritanceHierarchyType.None, "PatientEntity", new PatientEntityFactory())
		{
		}



		/// <summary>Retrieves in the calling PatientCollection object all PatientEntity objects which have data in common with the specified related Entities. If one is omitted, that entity is not used as a filter. </summary>
